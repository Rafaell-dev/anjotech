...
const DetailsComplete: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  return (
    <>
      {isOpen && (
        <div className='position-modal'>
          ...
          <div className='bg-modal overflow-auto max-h-screen '>
            <div className='flex justify-between'>
              <h2 className='text-2xl font-bold'>Plano Completo</h2>
              ...
              <div className='flex max-md:flex-col gap-8'>
                <div className='flex flex-col justify-between md:w-1/2'>
                  <div className=''>
                    ...
                    <div className='flex border p-2 rounded-lg'>
                      <p className='text-sm'>
                        Quem está há procura de colocar seu site online sem dor
                        de cabeça com hospedagem
                      </p>
                    </div>
                  </div>
                  <div className=''>
                ...
                <div className='md:w-1/2'>
                  ...
                  <div className='flex flex-col justify-center border p-2 rounded-lg'>
                    ...
                    <div className='flex items-center border-b'>
                      <Check className='cursor-pointer' color='black' />
                      <p className='text-sm p-2'>Hospedagem</p>
                      <Tooltip
                        title='Hospedagem já inclusa no plano.'
                        arrow
                        size='sm'
                        placement='right'
                      >
                    ...
                    <div className='flex items-center'>
                      <Check className='cursor-pointer' color='black' />
                      <p className='text-sm p-2'>Domínio .br</p>
                      <Tooltip
                        title='Ajudamos você a gerenciar sua Renovação de domínio.'
                        arrow
                        size='sm'
                        placement='right'
                      >
